        ...
        for ($linha = 4; $linha <= 207; $linha++) {
           // echo "<tr>";
            ...
            for ($coluna = 0; $coluna < 20; $coluna++) {
                ...
                switch ($coluna){
                case 0: $planilha->setEstagiario($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 1: $planilha->setMae($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 2: $planilha->setPai($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 3: $planilha->setCpf($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 4: $planilha->setRg($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 5: $planilha->setEndereco($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 6: $planilha->setNumero($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 7: $planilha->setComplemento($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 8: $planilha->setBairro($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 9: $planilha->setBanco($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 10: $planilha->setAgencia($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 11: $planilha->setConta($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 12: $planilha->setInstituicao($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 13: $planilha->setCurso($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 14: $planilha->setBolsa($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 15: $planilha->setCarga($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 16: 
                ...
                break;
                case 18: $planilha->setCliente($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                case 19: $planilha->setCnpj($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($coluna, $linha)->getValue()); break;
                }
